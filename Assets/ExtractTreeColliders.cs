...
{
    [SerializeField] private GameObject treeNavObj;
    [ContextMenu("Extract")]
    public void Extract()
    {
        ...
        for (int i = 0; i < terrain.terrainData.treePrototypes.Length; i++)
        {
            ...
            for (int j = 0; j < instances.Length; j++)
            {
                ...
                GameObject obj = Instantiate(treeNavObj);
                ...
                obj.GetComponent<NavMeshObstacle>().size = nav_mesh_obstacle.size;
                obj.GetComponent<NavMeshObstacle>().center = nav_mesh_obstacle.center;
                obj.GetComponent<NavMeshObstacle>().radius = nav_mesh_obstacle.radius;
