...
public class BeamShot : ISpellBehaviour
{
    ...
    public void Cast(PlayerController  player, Projectile proj){
        ...
        proj.dir = (proj.transform.TransformDirection(Vector3.forward)+0.005f*Random.insideUnitSphere*proj.player.accuracyMult).normalized;
        proj.player.ApplyKickback(1.4f);
   }
